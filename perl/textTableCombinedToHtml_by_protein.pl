...
print OUTFILE "[plain] -- for each identified peptide, the quantified ratio<BR>";
...
print OUTFILE "<b>mean.set columns:</b><BR>";
print OUTFILE "[bold] and [plain] -- mean value of measured ratios in this group (excluding singleton ratios if specified)<BR>";
print OUTFILE "<b>noqp.set columns:</b><BR>";
print OUTFILE "[bold] and [plain]-- number of quantified peptides for median and mean calculation)<BR>";
